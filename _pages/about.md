...
코드 리뷰와 사내 스터디를 리딩하면서 개발 문화 개선에 기여했습니다.

### 스페이스컬쳐 (2019.09~2020.01) 백엔드팀 - 백엔드 개발
인테리어 가구 판매 서비스를 개발하는 스타트업의 백엔드 팀을 리딩하며 인프라 구축 및 프로토타입 수준의 결제, 채팅 등 API를 개발했습니다.

### 애드오피 (2018.09~2019.09) 개발팀 - 백엔드 개발(AWS 인프라 관리)
광고 미디에이션 서비스 기업에서 광고 비용 정산 서비스, AMP 변환 서비스 등을 개발, 운영했습니다.  
AWS 인프라 관리, 비용 최적화를 통해 클라우드 비용을 절감했습니다.

### 미림미디어랩 (2017.04~2018.01) 플랫폼 개발팀 - 앱, 백엔드 개발
이러닝 서비스 기업 스타트업에서 콘텐츠 동영상 재생 서비스의 하이브리드 앱과 API 서버를 개발했습니다.
...
* 의료 진료 서비스 API 서버의 파드 메모리의 limit, request 값을 동일하게 설정  
  향후 K8s 리소스 요청 시 한정적인 자원으로 인해 발생할 수 있는 장애 방지 목적
...
* 진료 업무 시 자주 함께 사용되는 진단, 처방 코드를 한 번에 사용하는 묶음 기능 구현  
