...
> * 매체 기사를 AMP 데이터로 파싱하는 모듈 및 AMP 서버 개발, 유지보수
> * 사내 인사 시스템 유지보수
...
> * 유튜브를 벤치마킹한 미디어박스(콘텐츠 동영상 재생 플랫폼) 앱과 API 서버 개발, 유지보수
...
> **담당 업무**
> * 광고 송출 서비스(서버)의 트래픽을 AWS CloudWatch 콘솔을 통해 모니터링, 대응
...
* Java(Spring Boot), MyBatis, Gradle, TypeScript(Ionic), AWS(EC2, RDS), Vimeo API
